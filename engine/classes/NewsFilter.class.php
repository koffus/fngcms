...
class NewsFilter {
	...
	// Form generator
	public function addNewsForm(&$tvars) { return 1;}

	// Adding executor [done BEFORE actual add and CAN block adding ]
	public function addNews(&$tvars, &$SQL) { return 1;}

	// Adding notificator [ after successful adding ]
	public function addNewsNotify(&$tvars, $SQL, $newsid) { return 1;}

	// ### Edit news interceptor ###
	// Form generator
	public function editNewsForm($newsID, $SQLnews, &$tvars) { return 1; }

	// Edit executor [done BEFORE actual edit and CAN block editing ]
	public function editNews($newsID, $SQLnews, &$SQLnew, &$tvars) { return 1; }

	// Edit Notifier [ adfter successful editing ]
	public function editNewsNotify($newsID, $SQLnews, &$SQLnew, &$tvars) { return 1; }

	// List news form generator [ in admin panel ]
	public function listNewsForm($newsID, $SQLnews, &$tvars) { return 1; }

	// ### Delete news interceptor ###
	// Delete news call
	public function deleteNews($newsID, $SQLnews) { return 1; }
	...
	public function massModifyNews($idList, $setValue, $currentData) { return 1; }

	// Mass modify news call [ after news are modified ]
	public function massModifyNewsNotify($idList, $setValue, $currentData) { return 1; }
	...
	public function showNewsPre($newsID, &$SQLnews, $mode = array()) { return 1; }

	// Show news call :: processor (call after all processing is finished and before show) for each record
	public function showNews($newsID, $SQLnews, &$tvars, $mode = array()) { return 1; }
	...
	public function onBeforeNewsShow($newsID, $SQLnews, $mode = array()) { return 1; }
	public function onAfterNewsShow ($newsID, $SQLnews, $mode = array()) { return 1; }
	...
	public function onBeforeShowlist($mode)	{ return 1; }

	// Behaviour before/after showing news template
	// $mode	- calling mode (may be 'short' or 'full')
	public function onBeforeShow($mode) { return 1; }
	public function onAfterShow($mode) { return 1; }
