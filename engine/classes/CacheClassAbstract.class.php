...
class CacheClassAbstract {
	...
	function getMulti($plugin, $keyList, $expire = -1)	{	return false;	}
	function setMulti($plugin, $dataList, $expire = -1)	{	return false;	}
	function increment($plugin, $key, $offset = 1)		{	return false;	}
	function decrement($plugin, $key, $offset = 1)		{	return false;	}
}
