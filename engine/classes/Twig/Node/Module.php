 ...
 */
 ...
 if (count($this->getNode('blocks')) or count($this->getNode('traits')) or null === $this->getNode('parent') or $this->getNode('parent') instanceof Twig_Node_Expression_Constant) {
 ...
 $traitable = null === $this->getNode('parent') and 0 === count($this->getNode('macros'));
 if ($traitable) {
 ...
 if ($node instanceof Twig_Node_Text and ctype_space($node->getAttribute('data'))) {
 continue;
 }
