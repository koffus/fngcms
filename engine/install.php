...
if ( isset($_POST['action']) ) {
	switch ($_POST['action']) {
		...
		case 'install':		$flagPendingChanges = doInstall();	break;
		default:			doWelcome();						break;
	}
} else {
	doWelcome();
}
...
function doConfig() {
	switch ($_POST['stage']) {
		default:	doConfig_db(0);			break;
		case '1':	if (!doConfig_db(1))	break;
					doConfig_perm();		break;
		case '2':	doConfig_plugins();		break;
		case '3':	doConfig_templates();	break;
		case '4':	doConfig_common();		break;
	}
}
