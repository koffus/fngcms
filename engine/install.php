...
function doConfig_db($check)
{
 ...
 $tvars['vars']['error_message'] = '<div class="errorDiv">' . __('error.dbconnect') . ' "' . $_POST['reg_dbhost'] . '":<br/> (' . $mysql->db_errno() . ') ' . $mysql->db_error() . '</div>';
 $error = 1;
 }
 }
...
function doConfig_common()
{
 ...
 if (!isset($_POST['home_title'])) $_POST['home_title'] = __('common.title.default');
