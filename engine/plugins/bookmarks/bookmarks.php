	...
	function bookmarks(url, news, action){
		...
		ajaxBookmarks.onComplete = function (){
										if(ajaxBookmarks.response == "limit"){
											futu_alert("'.__('bookmarks:msg_title').'", "'.__('bookmarks:err_add_limit').'", true, "message");
										}	
										else if(ajaxBookmarks.response == "notlogged"){
											futu_alert("'.__('bookmarks:msg_title').'", "'.__('bookmarks:err_notlogged').'", true, "error");
										}	
										else if(ajaxBookmarks.response == "err_add"){
											futu_alert("'.__('bookmarks:msg_title').'", "'.__('bookmarks:err_add').'", true, "error");	
										} else { 
											...
											if(ajaxBookmarks.response.indexOf("<!-- add -->") != -1){
												futu_alert("'.__('bookmarks:msg_title').'", "'.__('bookmarks:msg_add').'", false, "save");
											}
											else{
												futu_alert("'.__('bookmarks:msg_title').'", "'.__('bookmarks:msg_delete').'", false, "save");
											}
										}
									};
...
function bookmarks_view(){
	...
	*/
	if (!$count) { $result = __('bookmarks:noentries'); }
...
function bookmarks_t(){
	global $mysql, $config, $userROW, $HTTP_REFERER, $SUPRESS_TEMPLATE_SHOW, $tpl, $bookmarksList, $bookmarksLoaded, $template, $twig;
