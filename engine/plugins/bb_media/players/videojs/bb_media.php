...
registerActionHandler('index', 'bbMediaInclude');
...
function bbMediaInclude()
{
    ...
    $cPlugin->regHtmlVar('css', admin_url . '/plugins/bb_media/players/videojs/lib/video-js.min.css');
    $cPlugin->regHtmlVar('js', admin_url . '/plugins/bb_media/players/videojs/lib/ie8/videojs-ie8.min.js');
    $cPlugin->regHtmlVar('js', admin_url . '/plugins/bb_media/players/videojs/lib/video.min.js');
    $cPlugin->regHtmlVar('plain', '<script> videojs.options.flash.swf = "' . admin_url . '/plugins/bb_media/players/videojs/lib/video-js.swf"; </script>');
    $cPlugin->regHtmlVar('js', admin_url . '/plugins/bb_media/players/videojs/lib/plugins/youtube/youtube.min.js');
}
