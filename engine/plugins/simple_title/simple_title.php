...
registerActionHandler('index_post', 'simple_tags');
...
elseif ($_GET['altname'] <> '')
{
$template['vars']['titles'] = str_replace(array('%1%','%2%','%3%'),array(p1,p2,p3),pluginGetVariable('simple_title','n_title'));
}

elseif ($_GET['altname'] == '' AND $_GET['category'] == '')
{
$template['vars']['titles'] = str_replace(array('%1%','%2%','%3%'),array(p1,p2,p3),pluginGetVariable('simple_title','m_title'));
}
}
...
define('p4', $st_name);
$template['vars']['titles'] = str_replace(array('%4%','%3%'),array(p4,p3),pluginGetVariable('simple_title','static_title'));
