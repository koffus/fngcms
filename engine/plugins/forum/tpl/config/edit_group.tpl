<form method="post" action="">
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="50%" class="contentEntry2"><input type="text" size="80" name="group_name" value="{{ group_name }}" /></td>
		</tr>
		<tr>
			<td width="50%" class="contentEntry1">Цвет</td>
			<td width="50%" class="contentEntry2"><input type="text" size="80" name="group_color" value="{{ group_color }}" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="50%" class="contentEntry1">Чтение новостей<br /><small></small></td>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="100%" colspan="2" class="contentEdit" align="center"><input type="submit" name="submit" value="Сохранить группу" class="button" /></td>
		</tr>
	</table>
</form>