...
<form method="post" action="" name="form">
		...
		<fieldset class="admGroup">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td class="contentEntry1">Объявление на главной<br /><small>Допускается всё без ограничения</small></td>
					<td class="contentEntry2"><textarea type="text" name="announcement" id="content" cols="60" rows="8">{{ announcement }}</textarea></td>
				</tr>
				<tr>
