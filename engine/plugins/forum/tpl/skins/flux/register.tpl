		...
		<form method="post" action="" enctype="multipart/form-data"> 
			<div class="inform"> 
				<div class="forminfo"> 
					...
					<p>Регистрация не обязательна, но она предоставит вам доступ к дополнительным возможностям. Например, появится возможность редактировать и удалять свои сообщения, добавлять собственную подпись ко всем сообщениям, подписаться на уведомления о новых сообщениях на форуме. Если у вас есть какие-нибудь вопросы относительно этого форума, вы можете обратиться к администратору.</p> 
					<p>Ниже приведена форма, которую Вы должны заполнить для того, чтобы зарегистрироваться. После регистрации, Вы должны посетить свой профиль и просмотреть введенную информацию, которую Вы сможете отредактировать в случае необходимости. Поля, заполняемые ниже - это только небольшая часть всех возможностей, которые Вы сможете изменять в своем профиле.</p> 
				</div> 
				<fieldset> 
			...
			<div class="inform"> 
				<fieldset> 
					...
					<div class="infldset"> 
						...
						<label class="conl"><strong>Подтвердите пароль</strong><br /><input type="text" name="confirm" maxlength="30" value="" /><br /></label> 
						<p class="clearb">Пароль должен быть не менее 4 и не более 16 символов в длину. Пароль чувствителен к регистру символов.</p> 
