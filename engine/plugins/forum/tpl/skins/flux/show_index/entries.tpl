	...
	<td class='tcr'>
		...
		<div class="last_post_img">Тема: 
			<span style="padding: 0px 3px 0px 0px;">
				<a href="{{ last_post_forum.profile_link }}" title="Профиль {{ last_post_forum.profile }}"><img src="{% if (last_post_forum.profile_avatar.true) %}{{ last_post_forum.profile_avatar.print }}{% else %}{{ last_post_forum.profile_avatar.print }}/noavatar.png{% endif %}" width="100" height="100" alt="" /></a>
			</span>
