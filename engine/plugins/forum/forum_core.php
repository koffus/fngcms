...
registerActionHandler('forum:core', 'forum_core');
registerActionHandler('index_post', 'forum_core');

registerActionHandler('forum:core', 'forum_group');
registerActionHandler('index_post', 'forum_group');

registerActionHandler('forum:function', 'forum_online');
registerActionHandler('forum:function', 'forum_browsing');