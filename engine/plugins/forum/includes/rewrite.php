...
function link_lock_passwd($id, $act = '', $pid)
{
	...
	switch($act){
		case '': $url = checkLinkAvailable('forum', 'lock_passwd')?
			generateLink('forum', 'lock_passwd', array('id' => $id)):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'lock_passwd'), array('id' => $id)); break;
		case 'pid': $url = checkLinkAvailable('forum', 'lock_passwd')?
			generateLink('forum', 'lock_passwd', array('id' => $id, 'pid' => $pid)):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'lock_passwd'), array('id' => $id, 'pid' => $pid)); break;
	}
	return $url;
}
...
function link_new_post($id, $act = '', $pid = 0)
{
	...
	switch($act)
	{
		case '': $url = checkLinkAvailable('forum', 'addreply')?
			generateLink('forum', 'addreply', array('id' => $id)):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'addreply'), array('id' => $id)); break;
		case 'pid': $url = checkLinkAvailable('forum', 'addreply')?
			generateLink('forum', 'addreply', array('id' => $id, 'pid' => $pid)):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'addreply'), array('id' => $id, 'pid' => $pid)); break;
	}
	return $url;
}
...
function link_profile($id, $act = '', $name)
{
	...
	$id = intval($id);
	switch($act){
		case '': $url = checkLinkAvailable('forum', 'profile')?
			generateLink('forum', 'profile', array('name' => $name, 'id' => $id)):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'profile'), array('id' => $id)); break;
		case 'edit': $url = checkLinkAvailable('forum', 'profile')?
			generateLink('forum', 'profile', array('name' => $name, 'id' => $id, 'act' => 'edit')):
			generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'profile'), array('id' => $id, 'act' => 'edit')); break;
	}
	return $url;
}
...
function link_topic($id, $act = '')
{
	...
	switch($act)
	{
		case '': $url = checkLinkAvailable('forum', 'showtopic')?
					generateLink('forum', 'showtopic', array('id' => $id)):
					generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'showtopic'), array('id' => $id)); break;
		
		case 'last': $url = checkLinkAvailable('forum', 'showtopic')?
					generateLink('forum', 'showtopic', array('id' => $id, 'act' => 'last')):
					generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'showtopic'), array('id' => $id, 'act' => 'last')); break;
		
		case 'pid': $url = checkLinkAvailable('forum', 'showtopic')?
					generateLink('forum', 'showtopic', array('pid' => $id)):
					generateLink('core', 'plugin', array('plugin' => 'forum', 'handler' => 'showtopic'), array('pid' => $id)); break;
	}
