...
$cfgX = array();
array_push($cfgX, array('name' => 'post_url', 'title' => 'URL платёжного шлюза', 'descr' => 'Значение опции `<b>Адрес шлюза</b> в настройках вашего <b>sms:банк</b>а','type' => 'input', value => pluginGetVariable('fin_smscoin','post_url')));
array_push($cfgX, array('name' => 'bank_id', 'title' => 'Идентификатор вашего сервиса <b>sms:банк</b>', 'descr' => 'Необходимо указать идентификационный номер вашего сервиса <b>sms:банк</b>','type' => 'input', value => intval(pluginGetVariable('fin_smscoin','bank_id'))));
array_push($cfgX, array('name' => 'secret_key', 'title' => 'Секрерный код', 'descr' => 'Данный секретный код вводится в настройках сервиса <b>смс:банк</b>','type' => 'input', value => pluginGetVariable('fin_smscoin','secret_key')));
array_push($cfgX, array('name' => 'clear_mode', 'title' => 'Вид суммы пополнения счёта', 'descr' => '<b>Платёж</b> - счёт пополняется на сумму, равную сумме платежа пользователя<br/><b>Прибыль</b> - счёт пополняется на сумму, равную полученной от отправки SMS прибыли','type' => 'select', 'values' => array(0 => 'Платёж', 1 => 'Прибыль'), 'value' => pluginGetVariable('fin_smscoin','clear_mode')));
