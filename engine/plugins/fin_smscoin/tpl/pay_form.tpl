...
<table>
<tr><td width=120>Внутренняя валюта:</td><td><b>{syscurrency}</b></td></tr>
<tr><td width=120>Ваша страна: </td><td><select name="s_country" id="s_country" onchange="updateOplist(this.value)"></select></td></tr>
<tr><td width=120>Ваш оператор: </td><td><select name="s_provider" id="s_provider" onchange="updatePrlist(document.getElementById('s_country').value, this.value)"></select></td></tr>
<tr><td width=120>Ваш платеж: </td><td><select name="s_payment" id="s_payment" size="6" style="width: 300px; height: 150px;"></select></td></tr>
