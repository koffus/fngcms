...
<tr>
<td width="100%" colspan="2" class="contentHead"><img src="{{skins_url}}/images/nav.gif" hspace="8" alt="" /><a href="admin.php?mod=extras" title="Плагины">Плагины</a> &#8594; <a href="{{admin_url}}/admin.php?mod=extra-config&plugin=faq">Вопросы и ответы</a></td>
</tr>
