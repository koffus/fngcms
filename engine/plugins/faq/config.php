...
global $tpl, $mysql, $twig;
	...
	$pagesss = $paginator->get( array('current' => $pageNo, 'count' => $countPages, 'url' => admin_url.'/admin.php?mod=extra-config&plugin=faq'.($news_per_page?'&rpp='.$news_per_page:'').'&page=%page%'));
