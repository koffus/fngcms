...
if (!isset($dependence['xfields'])) {
    ...
    if (isset($XFc['tdata']) and is_array($XFc['tdata'])) {
...
$cfg = array(
    'description' => 'Плагин реализует функционал "корзины товаров".',
