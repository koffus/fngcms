...
function main()
{
	...
	$tvars['vars']['locate_tpl_list'] = MakeDropDown(array(0 => __('gmanager:label_site'), 1 => __('gmanager:label_plugin')), 'locate_tpl', pluginGetVariable('gmanager', 'locate_tpl'));
	$tvars['vars']['if_auto_cash_list'] = MakeDropDown(array(0 => __('gmanager:label_no'), 1 => __('gmanager:label_yes')), 'if_auto_cash', pluginGetVariable('gmanager', 'if_auto_cash'));
	$tvars['vars']['if_description_list'] = MakeDropDown(array(0 => __('gmanager:label_no'), 1 => __('gmanager:label_yes')), 'if_description', pluginGetVariable('gmanager', 'if_description'));
	$tvars['vars']['if_keywords_list'] = MakeDropDown(array(0 => __('gmanager:label_no'), 1 => __('gmanager:label_yes')), 'if_keywords', pluginGetVariable('gmanager', 'if_keywords'));
	$tvars['vars']['main_row'] = pluginGetVariable('gmanager', 'main_row');
	$tvars['vars']['main_cell'] = pluginGetVariable('gmanager', 'main_cell');
	$tvars['vars']['main_page_list'] = MakeDropDown(array(0 => __('gmanager:label_no'), 1 => __('gmanager:label_yes')), 'main_page', pluginGetVariable('gmanager', 'main_page'));
	$tvars['vars']['one_row'] = pluginGetVariable('gmanager', 'one_row');
	$tvars['vars']['one_cell'] = pluginGetVariable('gmanager', 'one_cell');
	$tvars['vars']['one_page_list'] = MakeDropDown(array(0 => __('gmanager:label_no'), 1 => __('gmanager:label_yes')), 'one_page', pluginGetVariable('gmanager', 'one_page'));
	...
	$tvars['vars']['action'] = __('gmanager:button_general');
...
function showlist() {
	...
	$tvars['vars']['action'] = __('gmanager:button_list');
...
function edit()
{
	...
	$pvars['vars']['if_active_list'] = MakeDropDown(array(0 => __('gmanager:label_off'), 1 => __('gmanager:label_on')), 'if_active', $galery['if_active']);
	...
	$tvars['vars']['action'] = __('gmanager:button_edit');
...
function edit_submit()
{
	...
	if ($t_update)
	{
		...
		msg(array('type' => 'info', 'message' => __('gmanager:info_update_record')));
	}
...
function delete()
{
	...
	if (isset($_POST['commit']))
	{
		if ($_POST['commit'] == 'yes')
		{
			...
			msg(array('type' => 'info', 'message' => __('gmanager:info_delete')));
			if (pluginGetVariable('gmanager', 'if_auto_cash')) clear_cash();
		}
		showlist();
		return true;
	...
	$tvars['vars']['id'] = $id;
	$tvars['vars']['commit'] = sprintf(__('gmanager:desc_commit'), $galery['title']);
	...
	$tvars['vars']['action'] = __('gmanager:title_commit');
...
function clear_cash()
{
	...
	if (($dir = get_plugcache_dir('gmanager'))) {
		...
		msg(array('type' => 'info', 'message' => __('gmanager:info_cash_clear')));
	}
}