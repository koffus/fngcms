...
array_push($cfg, array('name' => 'perpage', 'title' => 'Кол-во комментариев для отображения на одной странице', 'type' => 'input', 'value' => pluginGetVariable($plugin, 'perpage')));
array_push($cfg, array('name' => 'comm_length', 'title' => 'Усечение длины комментария', 'descr' => 'Кол-во символов из комментария для отображения<br/>Значение по умолчанию: <b>50</b>', 'type' => 'input', 'html_flags' => 'size=5', 'value' => pluginGetVariable($plugin, 'comm_length')));
array_push($cfg, array('name' => 'order', 'title' => 'Упорядочить по:', 'descr' => 'Выберите порядок отображения комментариев.', 'type' => 'select', 'values' => array('asc' => 'Возрастанию', 'desc' => 'Убыванию'), 'value' => pluginGetVariable($plugin, 'order')));
