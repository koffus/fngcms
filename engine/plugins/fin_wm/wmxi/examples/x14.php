<?php
	...
	if (count($_POST) > 0) {
		...
		$response = $wmxi->X14(
			intval($_POST["inwmtranid"]), # целое число без знака
...
<body>
	...
	<a href="https://wiki.webmoney.ru/wiki/show/%d0%98%d0%bd%d1%82%d0%b5%d1%80%d1%84%d0%b5%d0%b9%d1%81+X14">https://wiki.webmoney.ru/wiki/show/Интерфейс+X14</a>
	<br />
