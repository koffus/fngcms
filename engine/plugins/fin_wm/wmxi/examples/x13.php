...
<body>
	...
	<a href="https://wiki.webmoney.ru/wiki/show/%d0%98%d0%bd%d1%82%d0%b5%d1%80%d1%84%d0%b5%d0%b9%d1%81+X13">https://wiki.webmoney.ru/wiki/show/Интерфейс+X13</a>
	<br />

	<form action="" method="post">

		<label>номер транзакции:</label>
		<input type="text" name="wmtranid" value="" />
		<br/>
