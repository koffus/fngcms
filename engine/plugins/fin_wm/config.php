...
$cfgX = array();
array_push($cfgX, array('name' => 'secret_key', 'title' => 'Секретный код сервиса <b>Web Merchant Interface</b>', 'descr' => 'Данный секретный код вводится в настройках сервиса https://merchant.webmoney.ru/ для вашего кошелька','type' => 'input', value => pluginGetVariable('fin_wm','secret_key')));
array_push($cfgX, array('name' => 'test_mode', 'title' => 'Режим работы', 'descr' => '<b>Реальный</b> - производится реальное списание средств с кошелька<br><b>Тестовый</b> - средства не списываются, проводится эмуляция списания. При этом тестовые средства <b><u>зачисляются</u></b> на внутренний кошелёк пользователя!','type' => 'select', values => array('0' => 'Реальный', '1' => 'Тестовый'), value => pluginGetVariable('fin_wm','test_mode')));
array_push($cfgX, array('name' => 'sign_mode', 'title' => 'Режим формирования подписи', 'descr' => '<b>MD5</b> - безопасность: <i>низкая</i>; но не требуется связи с сервисом WebMoney<br><b>SIGN</b> - безопасность: <i>средняя</i>; необходима связь с сервисом WebMoney<br><b>SIGN+AUTH</b> - безопасность: <i>высокая</i>; проводится проверка поступления средств на кошелёк','type' => 'select', values => array('0' => 'MD5'), value => pluginGetVariable('fin_wm','sign_mode')));
...
//array_push($cfgX, array('name' => 'currency', 'title' => 'Тип валюты кошелька на который производится приём денег','type' => 'select', 'values' => array('WMZ', 'WMR'), value => pluginGetVariable('fin_wm','currency')));
