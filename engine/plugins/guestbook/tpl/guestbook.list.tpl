<h2 class="section-title">Гостевая книга</h2>
...
<blockquote class="blockquote">
    <p class="mb-0">Мы дорожим мнением наших клиентов!</p>
    <footer class="blockquote-footer">Администрация сайта <cite title="{{ home_title }}"><a href="{{ home }}">{{ home_title }}</a></cite></footer>
</blockquote>
...
{% if(use_guests) %}
<div class="container">
<div class="alert alert-info">Гостям нельзя оставлять отзывы. Зарегистрируйтесь.</div>
</div>
{% else %}
...
<div class="form-group">
<button name="submit" type="submit" class="btn btn-success">Отправить отзыв</button>
