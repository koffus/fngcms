<form method="post" action="">
 ...
 <legend class="title">{{ lang['guestbook:social_vkontakte'] }}</legend>
 <table width="100%" border="0" class="content">
 <tr>
 <td class="contentEntry1" valign="top">{{ lang['guestbook:social_client_id'] }}</td>
 <td class="contentEntry2" valign="top">
 <input name="vk_client_id" type="text" size="50" value="{{ vk_client_id }}" />
 </td>
 </tr>
 <tr>
 <td class="contentEntry1" valign="top">{{ lang['guestbook:social_client_secret'] }}</td>
 <td class="contentEntry2" valign="top">
 ...
 <!-- FACEBOOK -->
 <fieldset class="admGroup">
 <legend class="title">{{ lang['guestbook:social_facebook'] }}</legend>
 <table width="100%" border="0" class="content">
 <tr>
 <td class="contentEntry1" valign="top">{{ lang['guestbook:social_client_id'] }}</td>
 <td class="contentEntry2" valign="top">
 ...
 <!-- GOOGLE -->
 <fieldset class="admGroup">
 <legend class="title">{{ lang['guestbook:social_google'] }}</legend>
 <table width="100%" border="0" class="content">
 <tr>
 <td class="contentEntry1" valign="top">{{ lang['guestbook:social_client_id'] }}</td>
 <td class="contentEntry2" valign="top">
 ...
 <!-- INSTAGRAM -->
 <fieldset class="admGroup">
 <legend class="title">{{ lang['guestbook:social_instagram'] }}</legend>
 <table width="100%" border="0" class="content">
 <tr>
 <td class="contentEntry1" valign="top">{{ lang['guestbook:social_client_id'] }}</td>
 <td class="contentEntry2" valign="top">
