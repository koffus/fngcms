...
function plugin_guestbook_install($action) {
 ...
 if ($action != 'autoapply') Lang::loadPlugin('guestbook', 'config', '', '', ':');
 ...
 switch ($action) {
 case 'confirm':generate_install_page('guestbook', 'Плагин позволяет организовать гостевую книгу на вашем сайте<br />');break;
 case 'autoapply':
 case 'apply':
 ...
 pluginSetVariable('guestbook', $k, $v);
 }
 pluginsSaveConfig();
 break;
 }
