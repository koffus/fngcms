...
array_push($cfgX, array('name' => 'sidepanel', 'title' => 'Включить генерацию боковой панели', 'descr' => '<b>Да</b> - панель будет генерироваться<br/><b>Нет</b> - панель не будет генерироваться', 'type' => 'select', 'values' => array ('0' => __('noa'), '1' => __('yesa')), 'value' => pluginGetVariable('lastcomments','sidepanel')));
...
$cfgX = array();
array_push($cfgX, array('name' => 'ppage', 'title' => 'Разрешить собственную страницу плагина', 'descr' => '<b>Да</b> - собственная страница разрешена<br/><b>Нет</b> - собственная страница запрещена', 'type' => 'select', 'values' => array ('0' => __('noa'), '1' => __('yesa')), 'value' => pluginGetVariable('lastcomments','ppage')));
...
$cfgX = array();
array_push($cfgX, array('name' => 'rssfeed', 'title' => 'Разрешить rss-ленту плагина', 'descr' => '<b>Да</b> - rss-лента разрешена<br/><b>Нет</b> - rss-лента запрещена', 'type' => 'select', 'values' => array ('0' => __('noa'), '1' => __('yesa')), 'value' => pluginGetVariable('lastcomments','rssfeed')));
