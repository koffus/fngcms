<tr><td width="100%" class="contentHead" colspan="3"><img src="/engine/skins/default/images/nav.gif" hspace="8" alt="" />Автоматическая генерация ключевых слов</td></tr>
<tr><td colspan="3">
<table width="100%">
<tr>
<td><input type="checkbox" id="autokeys_generate" name="autokeys_generate" value="1" {% if (flags.checked) %} checked="checked" {% endif %}class="check" /></td>
