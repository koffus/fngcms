...
pluginsLoadConfig();
	...
	array_push($cfg, array('name' => 'activate_add',	'title' => 'Автоматическое создание при добавлении новости<br/><small><b>Да</b> - ключевые слова будут автоматически создаваться при добавлении новости', 'type' => 'select', values => array(0 => __('noa'), 1 => __('yesa')), value => pluginGetVariable('autokeys','activate_add')));
	array_push($cfg, array('name' => 'activate_edit',	'title' => 'Автоматическое пересоздание при изменении новости<br/><small><b>Да</b> - ключевые слова будут автоматически пересоздаваться при изменении новости', 'type' => 'select', values => array(0 => __('noa'), 1 => __('yesa')), value => pluginGetVariable('autokeys','activate_edit')));
	...
	array_push($cfg, array('name' => 'block_y',	'title' => '<b>Нежелательные слова</b>', 'descr' => 'включение/выключение опции', 'type' => 'select', values => array(0 => __('noa'), 1 => __('yesa')), value => pluginGetVariable('autokeys','block_y')));
	...
	array_push($cfg, array('name' => 'good_y',	'title' => '<b>Желаемые слова</b>', 'descr' => 'включение/выключение опции', 'type' => 'select', values => array(0 => __('noa'), 1 => __('yesa')), value => pluginGetVariable('autokeys','good_y')));
	...
	array_push($cfg, array('name' => 'good_b',	'title' => '<b>Усиление слов</b>', 'descr' => 'Усиление слов в теге [b]', 'type' => 'select', values => array(0 => __('noa'), 1 => __('yesa')), value => pluginGetVariable('autokeys','good_b')));
