...
function plugin_gsmg_screen() {
 ...
 if (pluginGetVariable('gsmg','main')) {
 $output.= "<url>";
 $output.= "<loc>".generateLink('news', 'main', array(), array(), false, true)."</loc>";
 $output.= "<priority>".floatval(pluginGetVariable('gsmg', 'main_pr'))."</priority>";
 ...
 if (pluginGetVariable('gsmg', 'mainp')) {
 ...
 $output.= "<priority>".floatval(pluginGetVariable('gsmg', 'mainp_pr'))."</priority>";
 $output.= "<lastmod>".$lm['pd']."</lastmod>";
 $output.= "<changefreq>daily</changefreq>";
 $output.= "</url>";
 }
 ...
 $output.= "<priority>".floatval(pluginGetVariable('gsmg', 'cat_pr'))."</priority>";
 $output.= "<lastmod>".$lm['pd']."</lastmod>";
 $output.= "<changefreq>daily</changefreq>";
 $output.= "</url>";

 if (pluginGetVariable('gsmg', 'catp')) {
 ...
 $output.= "<priority>".floatval(pluginGetVariable('gsmg', 'catp_pr'))."</priority>";
 $output.= "<lastmod>".$lm['pd']."</lastmod>";
 $output.= "<changefreq>daily</changefreq>";
 $output.= "</url>";
 }
 ...
 if (pluginGetVariable('gsmg','news')) {
 ...
 if (pluginGetVariable('gsmg','static')) {
 ...
 $output.= "<url>";
 $output.= "<loc>".$link."</loc>";
 $output.= "<priority>".floatval(pluginGetVariable('gsmg', 'static_pr'))."</priority>";
 $output.= "<lastmod>".$lm['pd']."</lastmod>";
