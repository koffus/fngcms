...
registerActionHandler('index_post', 'plugin_ads_pro');
// - for extracting data from static pages
pluginRegisterFilter('static','ads_pro', new ADSProStaticFilter);
// - for extracting data from news
if (pluginGetVariable('ads_pro', 'support_news')) {
	pluginRegisterFilter('flag.news', 'ads_pro', new ADSProNewsFilter);
}
