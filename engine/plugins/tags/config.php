...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:block.sidebar').'</b>', 'entries' => $cfgX));
...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:block.ppage').'</b>', 'entries' => $cfgX));
...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:block.tpage').'</b>', 'entries' => $cfgX));
...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:block.stylecontrol').'</b>', 'entries' => $cfgX));
...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:block.display').'</b>', 'entries' => $cfgX));
...
array_push($cfg, array('mode' => 'group', 'title' => '<b>'.__('tags:cfg_cache').'</b>', 'entries' => $cfgX));
