	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_41.gif');" width="100%">&nbsp;<img border="0" src="{tpl_url}/images/bib.gif" /> <b>Облако тегов :: <b><font color="#FFFFFF">{tag}</font></b></td>
