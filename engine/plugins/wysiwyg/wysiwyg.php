...
if(getPluginStatusActive('comments')){
	...
	pluginRegisterFilter('comments', 'wysiwyg', new wysiwygFilterComments);
}

pluginRegisterFilter('static', 'wysiwyg', new wysiwygStaticFilter);
pluginRegisterFilter('news', 'wysiwyg', new wysiwygNewsFilter);