...
class JoditFileBrowser {
 ...
 $repl = array(
 'Р°'=>'a','Р±'=>'b','РІ'=>'v','Рі'=>'g','Рґ'=>'d','Рµ'=>'e','С‘'=>'yo','Р¶'=>'zh','Р·'=>'z','Рё'=>'i','Р№'=>'y',
 'Рє'=>'k','Р»'=>'l','Рј'=>'m','РЅ'=>'n','Рѕ'=>'o','Рї'=>'p','СЂ'=>'r','СЃ'=>'s','С‚'=>'t','Сѓ'=>'u','С„'=>'f',
 'С…'=>'h','С†'=>'ts','С‡'=>'ch','С€'=>'sh','С‰'=>'shch','СЉ'=>'','С‹'=>'i','СЊ'=>'','СЌ'=>'e','СЋ'=>'yu','СЏ'=>'ya',
 ' '=>'-',
 'Рђ'=>'A','Р‘'=>'B','Р’'=>'V','Р“'=>'G','Р”'=>'D','Р•'=>'E','РЃ'=>'Yo','Р–'=>'Zh','Р—'=>'Z','Р'=>'I','Р™'=>'Y',
 'Рљ'=>'K','Р›'=>'L','Рњ'=>'M','Рќ'=>'N','Рћ'=>'O','Рџ'=>'P','Р '=>'R','РЎ'=>'S','Рў'=>'T','РЈ'=>'U','Р¤'=>'F',
 'РҐ'=>'H','Р¦'=>'Ts','Р§'=>'CH','РЁ'=>'Sh','Р©'=>'Shch','РЄ'=>'','Р«'=>'I','Р¬'=>'','Р­'=>'E','Р®'=>'Yu','РЇ'=>'Ya',
 );
