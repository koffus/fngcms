...
<table>
<tr><td>Ваша страна:</td><td><select onkeyup="updateCountry();" onchange="updateCountry();" id="countrySelect"><option value="">-- загрузка --</select></td></tr>
<tr><td>Ваш сотовый оператор:</td><td><select onkeyup="updateOperator();" onchange="updateOperator();" id="operatorSelect"><option value="-">-- загрузка --</select></td></tr>
<tr><td>Короткие номера:</td><td>
<table id="snList" border=1>
<thead><tr><td>Короткий номер</td><td>Вы платите</td><td>Счет пополняется на</td></tr></thead>
<tbody><tr><td colspan=3>-- нет информации --</td></tr></tbody>
</table>
</td></tr>
</table>
<br/>
...
<table>
<tr><td width=55>Код: </td><td><input type=input name="passCode" /></td></tr>
<tr><td colspan=2><input type=submit value="Активировать секретный код" /></td></tr>
</table>
</form>
</div>