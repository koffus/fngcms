...
<tr><td>
	...
	<td style="background-image:url('{tpl_url}/images/2z_36.gif');" width="100%">&nbsp;<b><font color="#FFFFFF">Чат-бокс</font></b>[selfwin] <a target="_blank" href="{link_selfwin}"><img src="{skins_url}/images/open_new.png" width="15" height="11" border="0" alt="New window"/></a>[/selfwin]</td>
