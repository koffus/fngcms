...
$cfg = array('description' => 'Плагин реализует базовый функционал работы с комментариями.<br/>Обратите внимание: плагин для своей работы использует файлы-шаблоны из <u>основного шаблона сайта</u>.');

$cfgX = array();
	array_push($cfgX, array(
		'name' => 'regonly',
		'title' => "Комментарии только для зарегистрированных",
		'descr' => '<b>Да</b> - комментарии могут оставлять только зарегистрированные пользователи<br/><b>Нет</b> - комментарии может оставить любой посетитель',
		'type' => 'select',
