	...
	<form action="admin.php?mod=configuration" method="POST" class="form-horizontal">
		...
		<div id="userTabs" class="tab-content">
			...
			<div id="userTabs-system" class="tab-pane">
				...
				<td><input class="mailfrom_name form-control" type="text" id="mail_fromname" name="save_con[mailfrom_name]" value="{{ config['mailfrom_name'] }}" /></td>
				</tr>
				<tr>
				<td width="50%">{{ lang['mailfrom'] }} <span class="help-block">{{ lang['example'] }} mailbot@server.com</span></td>
				<td><input class="mailfrom form-control" type="text" id="mail_frommail" name="save_con[mailfrom]" value="{{ config['mailfrom'] }}" /></td>
				</tr>
				<tr>
				...
				<td><input class="mailfrom form-control" type="text" name="save_con[mail][smtp][host]" id="mail_smtp_host" value="{{ config['mail']['smtp']['host'] }}" /></td>
				</tr>
				<tr class="useSMTP">
				<td width="50%">{{ lang['smtp_port'] }}: <span class="help-block">{{ lang['example'] }} 25</span></td>
				<td><input class="mailfrom form-control" type="text" name="save_con[mail][smtp][port]" id="mail_smtp_port" value="{{ config['mail']['smtp']['port'] }}" /></td>
				</tr>
				<tr class="useSMTP">
				...
				<td><input class="mailfrom form-control" type="text" id="mail_smtp_login" name="save_con[mail][smtp][login]" value="{{ config['mail']['smtp']['login'] }}" /></td>
				</tr>
				<tr class="useSMTP">
				<td width="50%">{{ lang['smtp_auth_pass'] }}: <span class="help-block">{{ lang['example'] }} mySuperPassword</span></td>
				<td><input class="mailfrom form-control" type="text" name="save_con[mail][smtp][pass]" id="mail_smtp_pass" value="{{ config['mail']['smtp']['pass'] }}" /></td>
				</tr>
				<tr>
				<td width="50%"></td>
				<td style="display: block;">
					EMail: 
					<input type="email" name="" class="form-control" id="mail_tomail" value=""><br>
			...
			<div id="userTabs-multi" class="tab-pane">
				...
				<tr>
				<td width="50%">{{ lang['mydomains'] }} <span class="help-block">{{ lang['mydomains_desc'] }}</span></td>
				<td width="50%"><textarea name="save_con[mydomains]" class="form-control" rows="4">{{ config['mydomains'] }}</textarea></td>
				</tr>
