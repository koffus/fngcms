		...
		<div id="userTabs" class="tab-content">
			...
			<div id="userTabs-news" class="tab-pane">
				<fieldset>
					...
					<div class="form-group">
						<div class="col-md-5">{{ lang['timestamp_updated'] }} <span class="help-block">{{ lang['date_help'] }}</span></div>
						<div class="col-md-7"><input type="text" class="form-control" name="save_con[timestamp_updated]" value="{{ config['timestamp_updated'] }}" /> <span class="help-block">{{ lang['date_now'] }} {{ timestamp_updated_now }}</span></div>
					</div>
					<div class="form-group">
