                ...
                <!--div class="col col-md-4">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#">{{ lang.dbo.check }}</a></li>
                            <li><a href="#">{{ lang.dbo.repair }}</a></li>
                            <li><a href="#">{{ lang.dbo.optimize }}</a></li>
                            <li><a href="#">{{ lang.dbo.cat_recount }}</a></li>
                            <li class="divider"></li>
                            <li class="dropdown-header">Резервная копия</li>
                            <li><a href="#">{{ lang.dbo.backup }}</a></li>
                            <li><a href="#">Создать и {{ lang.dbo.gzencode }}</a></li>
                            <li><a href="#">Создать и {{ lang.dbo.email_send }}</a></li>
                            <li class="divider"></li>
                            <li class="dropdown-header">Конвертация</li>
                            <li><a href="#">cp1251 => utf8</a></a></li>
                            <li class="divider"></li>
                            <li><a href="#" onclick="if (confirm('{{ lang['sure_del'] }}') == true) {return false;} else {} ">cp1251 => utf8</a></a></li>
                          </ul>
                    </div>
                </div-->
