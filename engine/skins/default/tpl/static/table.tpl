                    ...
                    {% for entry in entries %}
                        <tr>
                            ...
                            <td nowrap>{% if (entry.url) %}
                                ...
                                {% endif %}</td>
                            <td>{% if (perm.details) %}<a href="admin.php?mod=static&amp;action=editForm&amp;id={{ entry.id }}">{% endif %}{{ entry.title }}{% if (perm.details) %}</a>{% endif %}
                                <br/>
                                <a href="{{ entry.url }}" target="_blank">{{ entry.url }}</a></td>
