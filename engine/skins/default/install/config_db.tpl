            ...
            <form name="form" id="form" action="" method="post" class="f1 form-horizontal">
                ...
                <fieldset>
                    ...
                    <div class="form-group has-feedback">
                        <label class="col-sm-3 control-label">{l_db.engine}</label>
                        <div class="col-sm-9">
                            <select name="reg_dbengine" class="form-control">
                                <option value="MyISAM">MyISAM</option>
                                <option value="InnoDB">InnoDB</option>
                            </select>
                            <span class="help-block">{err:reg_dbhost} {l_db.engine#desc}</span>
                        </div>
                    </div>
                    <div class="form-group has-feedback">
