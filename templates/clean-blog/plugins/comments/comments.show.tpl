<li id="comment_{id}">
	<div class="comment clearfix">
		...
		<div class="comment-content">
			...
			<div class="meta">{date} | [quote]<a onmouseover="copy_quote('{author}');" onclick="quote();" style="cursor: pointer;">Ответить</a>[/quote][if-have-perm]| [edit-com]Изменить[/edit-com] | [del-com]Удалить[/del-com][/if-have-perm]</div>
